...
class Model_Driver {
	...
	public function __construct() {
		...
		if($this->ins_db->connect_error) {
			throw new DbException("Բազային միացման սխալ.".$this->ins_db->connect_errno."|".$this->ins_db->connect_error);
		}
	...
	public function select(
		...
		*/
		...
		/*
		if(!$result) {
			throw new DbException("Տվյալների դուրս բերում բազայից չհաջողվեց".$this->ins_db->connect_errno."|".$this->ins_db->connect_error);
		}
		*/
